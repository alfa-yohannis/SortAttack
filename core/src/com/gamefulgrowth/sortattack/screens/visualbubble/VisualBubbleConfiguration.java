...
public class VisualBubbleConfiguration implements Screen {

	public static final int LEVEL_NUMBER = 3;
	private static final String HEADING_TEXT = "Bubble Sort Visualization";
	private Stage stage;
	private Skin skin;
	...
	public void show() {
		...
		Sort.writeLogs("Bubble Sort Visualization: Configuration is started");
		...
		btnLaunchViz.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				...
				Sort.writeLogs("Bubble Sort Visualization: Visualize " + txtFldArray.getText());
				Sort.assetManager.get("sounds/menuclick.wav", Sound.class)
						.play();
				
				Sort.screens.put(HEADING_TEXT,
						new VisualBubbleLevelNN(0, HEADING_TEXT, boxes));
		...
		btnBack.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				...
				Sort.writeLogs("Bubble Sort Visualization: Quit from Bubble Sort Configuration");
				Sort.assetManager.get("sounds/menuclick.wav", Sound.class)
						.play();
				((Game) Gdx.app.getApplicationListener())
