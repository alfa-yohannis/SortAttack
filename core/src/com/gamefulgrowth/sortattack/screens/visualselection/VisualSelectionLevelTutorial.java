...
import com.gamefulgrowth.sortattack.screens.selection.SelectionLevelTutorial;

public class VisualSelectionLevelTutorial extends SelectionLevelTutorial {

	public VisualSelectionLevelTutorial() {
		super();
	...
	public void show() {
		...
		btnQuit.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				Sort.writeLogs("Selection Sort Visualization: Quit from Selection Sort Visualization Tutorial");
