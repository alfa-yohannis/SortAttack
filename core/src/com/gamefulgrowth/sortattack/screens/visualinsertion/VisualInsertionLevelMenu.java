...
public class VisualInsertionLevelMenu implements Screen {

	private String ALGORITHM_TYPE = "Insertion Sort Visualization";
	public static final int LEVEL_NUMBER = 3;
	private static final String HEADING_TEXT = "Insertion Sort Visualization Menu";
	private Stage stage;
	private Skin skin;
	...
	public void show() {
		...
		btnBack.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				Sort.writeLogs(ALGORITHM_TYPE + ": Quit from Insertion Sort Level Selection Menu");
	...
	private void setEachLevelButtonAction() {
		...
		levelConfigurationList.add(new LevelConfiguration(1,
				"Insertion Sort Level 1", new int[] {}));
		textButton.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				Sort.writeLogs(ALGORITHM_TYPE + ": Insertion Sort Introduction is selected");
				Sort.assetManager.get("sounds/menuclick.wav", Sound.class)
						.play();
				Sort.screens.put(
						VisualInsertionLevelIntroduction.class.toString(),
						new VisualInsertionLevelIntroduction());
				((Game) Gdx.app.getApplicationListener())
						.setScreen(Sort.screens
								.get(VisualInsertionLevelIntroduction.class
										.toString()));
			}
		});
		...
		levelConfigurationList.add(new LevelConfiguration(2,
				"Insertion Sort Level 2", new int[] {}));
		textButton.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				Sort.writeLogs(ALGORITHM_TYPE + ": Insertion Sort Tutorial is selected");
				Sort.assetManager.get("sounds/menuclick.wav", Sound.class)
						.play();
				Sort.screens.put(VisualInsertionLevelTutorial.class.toString(),
						new VisualInsertionLevelTutorial());
				((Game) Gdx.app.getApplicationListener())
						.setScreen(Sort.screens
								.get(VisualInsertionLevelTutorial.class
										.toString()));
			}
		});
		...
		textButton.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				Sort.writeLogs(ALGORITHM_TYPE + ": Insertion Sort Configuration is selected");
				Sort.assetManager.get("sounds/menuclick.wav", Sound.class)
						.play();
				Sort.screens.put(VisualInsertionConfiguration.class.toString(),
						new VisualInsertionConfiguration());
				((Game) Gdx.app.getApplicationListener())
						.setScreen(Sort.screens
								.get(VisualInsertionConfiguration.class
										.toString()));
			}
		});
