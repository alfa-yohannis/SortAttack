...
public class VisualInsertionConfiguration implements Screen {

	public static final int LEVEL_NUMBER = 3;
	private static final String HEADING_TEXT = "Insertion Sort Visualization";
	private Stage stage;
	private Skin skin;
	...
	public void show() {
		...
		Sort.writeLogs("Insertion Sort Visualization: Configuration is started");
		...
		btnLaunchViz.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				...
				Sort.writeLogs("Insertion Sort Visualization: Visualize " + txtFldArray.getText());
				Sort.assetManager.get("sounds/menuclick.wav", Sound.class)
						.play();
				
				Sort.screens.put(HEADING_TEXT,
						new VisualInsertionLevelNN(0, HEADING_TEXT, boxes));
		...
		btnBack.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				...
				Sort.writeLogs("Insertion Sort Visualization: Quit from Insertion Sort Configuration Menu");
				Sort.assetManager.get("sounds/menuclick.wav", Sound.class)
						.play();
				((Game) Gdx.app.getApplicationListener())
