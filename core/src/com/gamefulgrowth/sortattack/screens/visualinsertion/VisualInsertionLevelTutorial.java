...
import com.gamefulgrowth.sortattack.screens.insertion.InsertionLevelTutorial;

public class VisualInsertionLevelTutorial extends InsertionLevelTutorial {

	public VisualInsertionLevelTutorial() {
		super();
	...
	public void show() {
		...
		btnQuit.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				Sort.writeLogs("Insertion Sort Visualization: Quit from Insertion Sort Visualization Tutorial");
